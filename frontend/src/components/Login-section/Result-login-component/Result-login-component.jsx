...
const ResultLoginComponent = (props) => {
    ...
    <div className="body-results-form">
      <div className="container-results-form">
        ...
        <div className="subscription-section-parent">
          ...
          <p>Découvrez nos différent plans tarifaires pour répondre à vos besoins.</p>
          ...
          <PaymentModalComponent isOpen={isModalOpen} onRequestClose={closeModal} formData={formData} />
        </div>
      </div>
    </div>
  );
